! for fortran95
! for transformation of coordinate of standard stars on the each image.
! Updated at 18. Dec. 2007, 19:46 KST by Hur Hyeon-Oh
      parameter(mnstar=999999)
      real*8 coo(2,mnstar),xcoo(100),ycoo(100),x,y
      real*8 dx,dy,xm,ym,xt,yt
      character input(100)*15,output(100)*15,a*1,master*15,targets*15
      character inputfile*16
      integer ninput,nstar,m
100   format(a15,t17,f7.2,t25,f7.2) 
101   format(a15)
      print *,''
      print *,'Coordinate transformming program for IRAF photometry.'
      print *,''
      print *,'V1.00, updated at Dec,18, 2007  by Hyeon-Oh Her'
      print *,''
c      print *,'input file name : dcoo.tr'
