...
70    do i=1,ns
       ...
       read(21,*,end=100) (inf_out(i,j),j=1,nimage)
       read(21,*,end=100) (mag(i,j),j=1,nimage)
       read(21,*,end=100) (inmag(i,j),j=1,nimage)
       read(21,*,end=100) (merr(i,j),j=1,nimage)
       read(21,*,end=100) (xc(i,j),j=1,nimage)
       read(21,*,end=100) (yc(i,j),j=1,nimage)
       read(21,'(a19)',end=100) output
       read(21,'(a19)',end=100) output
       read(21,'(a19)',end=100) output
c       write(*,*) (ID(i,j),j=1,nimage)
c       write(*,*) (inf_out(i,j),j=1,nimage)
c       write(*,*) (mag(i,j),j=1,nimage)
c       write(*,*) (inmag(i,j),j=1,nimage)
c       write(*,*) (merr(i,j),j=1,nimage)
c       write(*,*) (xc(i,j),j=1,nimage)
c       write(*,*) (yc(i,j),j=1,nimage)
c       write(*,'(a19)') output
c       write(*,'(a19)') output
c       write(*,'(a19)') output
      enddo
